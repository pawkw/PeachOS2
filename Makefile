FILES = ./build/kernel.asm.o ./build/kernel.o ./build/io/io.asm.o ./build/idt/idt.asm.o ./build/idt/idt.o ./build/memory/memory.o ./build/memory/heap/heap.o ./build/memory/heap/kernel_heap.o
INCLUDES = -I./src
